...
public class SecurityFragment1 extends Fragment {
    ...
    public SecurityFragment1()
    {}

    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState)
    {
        mMainView = inflater.inflate(R.layout.fragment_security_fragment1, container, false);
        mUsersDatabase=FirebaseDatabase.getInstance().getReference().child("Users");
        list=(RecyclerView)mMainView.findViewById(R.id.list);
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Complaints").child("Security");
    ...
    {
        super.onStart();
        FirebaseRecyclerAdapter<Citizen,SecurityFragment1.ComplaintsViewHolder> complaintRecyclerViewAdapter=new FirebaseRecyclerAdapter<Citizen, ComplaintsViewHolder>(Citizen.class,R.layout.user_single_layout,SecurityFragment1.ComplaintsViewHolder.class,mDatabase) {
            @Override
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        chatIntent.putExtra("sender","Security");
