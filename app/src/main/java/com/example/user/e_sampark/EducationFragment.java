...
public class EducationFragment extends Fragment {
    ...
    private void chat() {
        ...
        in.putExtra("reciever","Education");
        startActivity(in);
    }

    public void delete()
    {
        mDatabase.child(current_user_id).child("Education").removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                mDatabase.child("Education").child(current_user_id).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        mMessages.child(current_user_id).child("Education").removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                mMessages.child("Education").child(current_user_id).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
