...
public class EducationFragment1 extends Fragment {
    ...
    public EducationFragment1()
    {}

    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState)
    {
        mMainView = inflater.inflate(R.layout.fragment_education_fragment1, container, false);
        mUsersDatabase=FirebaseDatabase.getInstance().getReference().child("Users");
        list=(RecyclerView)mMainView.findViewById(R.id.list);
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Complaints").child("Education");
    ...
    {
        super.onStart();
        FirebaseRecyclerAdapter<Citizen,EducationFragment1.ComplaintsViewHolder> complaintRecyclerViewAdapter=new FirebaseRecyclerAdapter<Citizen, ComplaintsViewHolder>(Citizen.class,R.layout.user_single_layout,EducationFragment1.ComplaintsViewHolder.class,mDatabase) {
            @Override
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        chatIntent.putExtra("sender","Education");
